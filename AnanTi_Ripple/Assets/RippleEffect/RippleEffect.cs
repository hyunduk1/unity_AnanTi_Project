...
public class RippleEffect : MonoBehaviour
{
    ...
    public class Droplet
    {
        ...
        public void Reset()
        {
            position = new Vector2(fPosX, fPosy);
    ...
    void UpdateShaderParameters()
    {
        ...
        {
            droplets[i].fPosX = Input.mousePosition.x / 1520;
            droplets[i].fPosy = Input.mousePosition.y / 1280;
            /*droplets[i].fPosX = Input.mousePosition.x / CConfigMng.Instance._ScreenSizeX;
            droplets[i].fPosy = Input.mousePosition.y / CConfigMng.Instance._ScreenSizeY;*/
    ...
    private void Start()
    {
        /*reflectionStrength = CConfigMng.Instance._fRippleStrength;
        waveSpeed = CConfigMng.Instance._fSpeed;
        dropInterval = CConfigMng.Instance._fDropIneterval;*/
